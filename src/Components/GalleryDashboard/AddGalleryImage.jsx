...
export default function AddGalleryImage() {
    ...
    return (
        ...
        <div className="modal fade w-100" id="modal1" tabIndex="-1" aria-labelledby="modal1Label" aria-hidden="true">
                            ...
                            <div className={style.inputFiled}>
                                ...
                                <div className='d-flex justify-content-between gap-3 mb-3'>
                                    ...
                                    <div className=" w-100">
                                        ...
                                        <input type="file" id="image" name="image" onChange={(event) => formik.setFieldValue('image', event.target.files[0])}
